...
$API_KEY = "5469168051:AAHQgJ0PmUF2fOv9to405o2RGLApz4rl41s";
$Dev = array("513074001", "513074001" );  
flush();
ob_start();
set_time_limit(0);
error_reporting(0);
...
",
  'reply_to_message_id'=>$message_id,
    ...
    'inline_keyboard'=>[
 	[
['text'=>"🎉تابع جديدنا",'url'=>"https://t.me/hsh456"],['text'=>"$dataadd",'callback_data'=>"text"]
	  ],
   ]
   ])
     ]); 
...
bot( sendaudio ,[
 chat_id =>$chat_id, 
 audio =>"https://t.me/botysongs/4?single",
 reply_to_message_id =>$message->message_id, 
]);
}
}
...
bot( sendaudio ,[
 chat_id =>$chat_id, 
 audio =>"https://t.me/botysongs/5?single",
 reply_to_message_id =>$message->message_id, 
]);
}
}
...
",
   'reply_markup'=>json_encode([
    'inline_keyboard'=>[
	[
	['text'=>"√ • تنصيب بوت  • √",'url'=>"https://telegram.me/hsh456"]
              ] 
              ],
        ])
            ]);
